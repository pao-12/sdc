...
<div class="app">
  <aside class="sidebar">
    ...
    <nav class="nav">
      <a href="mostrar.php" class="nav-item active"><i class="ti ti-briefcase"></i><span>Mis Viáticos</span></a>
      <a href="formulario.php" class="nav-item"><i class="ti ti-circle-plus"></i><span>Nuevo Viático</span></a>
      <a href="#" class="nav-item"><i class="ti ti-user"></i><span>Mi Perfil</span></a>
    </nav>
  ...
  <main class="main">
    <div class="main-inner">
      ...
      <div class="footer-actions">
        <a href="mostrar.php" class="btn-back">Volver</a>
